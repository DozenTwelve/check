...
-- If status is voided, voided_at must be set.
ALTER TABLE daily_returns
...
-- deliveries_in_lines: one consumable per document.
...
-- deliveries_out_lines: one consumable per document.
...
-- daily_return_lines: one consumable per document.
